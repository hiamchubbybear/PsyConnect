...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<String>> handleGeneralException(Exception ex) {
        ...
        ApiResponse<String> response = new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Server Error", null);
    ...
    public ResponseEntity<ApiResponse<String>> handleNullPointerException(NullPointerException ex) {
        ...
        ApiResponse<String> response = new ApiResponse<>(HttpStatus.BAD_REQUEST.value(), "Null value encountered", null);
    ...
    public ResponseEntity<ApiResponse<String>> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        String errorMessage = ex.getBindingResult().getFieldErrors().stream().map(fieldError -> fieldError.getField() + ": " + fieldError.getDefaultMessage()).findFirst().orElse("Validation error");
    ...
    public ResponseEntity<ApiResponse<String>> handleMethodNotSupportedException(HttpRequestMethodNotSupportedException ex) {
        ...
        ApiResponse<String> response = new ApiResponse<>(HttpStatus.METHOD_NOT_ALLOWED.value(), "Method Not Allowed", null);
    ...
    public ResponseEntity<ApiResponse<String>> handleMissingParamsException(MissingServletRequestParameterException ex) {
        ...
        ApiResponse<String> response = new ApiResponse<>(HttpStatus.BAD_REQUEST.value(), "Missing parameter: " + "Bad Request", null);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
    }
    ...
    public ResponseEntity<ApiResponse<String>> handleDataAccessException(DataAccessException ex) {
        ...
        ApiResponse<String> response = new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Database error", null);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
    }
