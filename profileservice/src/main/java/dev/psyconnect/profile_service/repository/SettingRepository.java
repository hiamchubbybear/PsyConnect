...
public interface SettingRepository extends Neo4jRepository<Setting, String> {
    ...
    @Query("""
            ...
            RETURN s
            """)
    Optional<Setting> createUserSetting(@Param("profileId") String profileId, @Param("privacyLevel") String privacyLevel, @Param("showLastSeen") boolean showLastSeen, @Param("showProfilePicture") boolean showProfilePicture, @Param("showMood") boolean showMood, @Param("notificationsEnabled") boolean notificationsEnabled, @Param("emailNotifications") boolean emailNotifications, @Param("pushNotifications") boolean pushNotifications, @Param("smsNotifications") boolean smsNotifications, @Param("twoFactorAuth") boolean twoFactorAuth, @Param("allowLoginAlerts") boolean allowLoginAlerts, @Param("trustedDevices") String trustedDevices, @Param("language") String language, @Param("theme") String theme, @Param("autoDeleteOldMoods") boolean autoDeleteOldMoods);
    ...
    @Query("""
            ...
            RETURN s
            """)
    Optional<Setting> updateUserSetting(@Param("profileId") String profileId, @Param("privacyLevel") String privacyLevel, @Param("showLastSeen") boolean showLastSeen, @Param("showProfilePicture") boolean showProfilePicture, @Param("showMood") boolean showMood, @Param("notificationsEnabled") boolean notificationsEnabled, @Param("emailNotifications") boolean emailNotifications, @Param("pushNotifications") boolean pushNotifications, @Param("smsNotifications") boolean smsNotifications, @Param("twoFactorAuth") boolean twoFactorAuth, @Param("allowLoginAlerts") boolean allowLoginAlerts, @Param("trustedDevices") String trustedDevices, @Param("language") String language, @Param("theme") String theme, @Param("autoDeleteOldMoods") boolean autoDeleteOldMoods);
