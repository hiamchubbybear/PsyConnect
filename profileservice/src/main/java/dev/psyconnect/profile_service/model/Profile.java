...
public class Profile implements Serializable {
    ...
    private @GeneratedValue(UUIDStringGenerator.class)
    @Id String profileId;
    ...
    private @Relationship(type = "HAS_ACTIVITY", direction = Relationship.Direction.OUTGOING) List<ActivityLog> activityLogs;
