...
public class SocialController {
    ...
    public ApiResponse<FriendRequestResponse> friendRequest(@RequestBody FriendRRequest receiver, @RequestHeader("X-Profile-Id") String sender) {
        return new ApiResponse<>(friendsService.createFriend(receiver, sender));
    }

    @PostMapping("/friend/accept")
    public ApiResponse<FriendAcceptResponse> friendAccept(@RequestBody FriendAcceptationRequest receiver, @RequestHeader("X-Profile-Id") String sender) {
        return new ApiResponse<>(friendsService.acceptFriend(receiver, sender));
    }

    @PostMapping("/friend/unfriend")
    public ApiResponse<UnFriendResponse> friendAccept(@RequestBody UnfriendRequest receiver, @RequestHeader("X-Profile-Id") String sender) {
        return new ApiResponse<>(friendsService.unFriend(receiver, sender));
    }

    @PostMapping("/friend/undo")
    public ApiResponse<UndoFriendRequestResponse> friendAccept(@RequestBody UndoFriendRRequest receiver, @RequestHeader("X-Profile-Id") String sender) {
        return new ApiResponse<>(friendsService.undoRequest(receiver, sender));
    }

    @DeleteMapping("/friend/request")
    public ApiResponse<DeclineFriendRequestResponse> friendAccept(@RequestBody DeclineFriendRRequest receiver, @RequestHeader("X-Profile-Id") String sender) {
