          ...
          <div class="steps-progress">
            ...
            >
              ...
              <span class="step-label">{{
                'CONSULTATION.CreateProfile.StepConfig' | translate
              }}</span>
            </div>
            ...
            >
              ...
              <span class="step-label">{{
                'CONSULTATION.CreateProfile.StepAttributes' | translate
              }}</span>
            </div>
            ...
            >
              <div class="step-indicator">
                <span *ngIf="currentStep > 3" class="step-check">✓</span>
                <span *ngIf="currentStep <= 3">3</span>
              </div>
              <span class="step-label">{{
                'CONSULTATION.CreateProfile.StepDetails' | translate
              }}</span>
            </div>
            ...
            >
              ...
              <span class="step-label">{{
                'CONSULTATION.THERAPIST.ProfessionalInfo' | translate
              }}</span>
            </div>
            ...
            <div
              ...
              [style.transform]="'translateY(' + (currentStep - 1) * 60 + 'px)'"
            ></div>
          </div>
        </aside>
          ...
          <form [formGroup]="profileForm" (ngSubmit)="createProfile()">
            <div class="content-header">
              ...
              <div class="header-actions">
                ...
                <button
                  *ngIf="currentStep < (role === 'therapist' ? 4 : 3)"
                  type="button"
                  class="btn-next"
                  (click)="nextStep()"
                >
                  {{ 'COMMON.Next' | translate }} &rsaquo;
                </button>
                <button
                  *ngIf="currentStep === (role === 'therapist' ? 4 : 3)"
                  type="submit"
                  class="btn-next"
                  [disabled]="profileForm.invalid || creating"
                >
                  {{
                    creating
            ...
            <div class="step-pane" [class.active-pane]="currentStep === 1">
              <div class="section-group" style="--anim-delay: 1">
                <h4>
                  {{ 'CONSULTATION.THERAPIST.ConsultationModes' | translate }}
                </h4>
                <p class="section-desc">
                  {{
                    'CONSULTATION.CreateProfile.ConsultationModesDesc'
                      | translate
                  }}
                </p>
                <div class="card-grid">
              ...
              <div class="section-group" style="--anim-delay: 2">
                ...
                <p class="section-desc">
                  {{
                    role === 'therapist'
                      ? ('CONSULTATION.THERAPIST.PriceDesc' | translate)
                      : ('CONSULTATION.CLIENT.BudgetDesc' | translate)
                  }}
                </p>
                <div style="display: flex; gap: 1rem; max-width: 400px;">
                  <input
                    type="number"
                    formControlName="rage_price"
                    class="form-input"
                    [placeholder]="
                      'CONSULTATION.THERAPIST.AmountPlaceholder' | translate
                    "
                    style="flex: 2;"
                  />
                  <select
                  ...
                  >
                    <option
                      *ngFor="let cur of availableCurrencies"
                      [value]="cur.id"
                    >
                      {{ cur.label }}
                    </option>
            ...
            <div class="step-pane" [class.active-pane]="currentStep === 2">
              <div class="section-group" style="--anim-delay: 1">
                ...
                <p class="section-desc">
                  {{ 'CONSULTATION.CreateProfile.LanguagesDesc' | translate }}
                </p>
                <div class="card-grid">
                  <div
              ...
              <div class="section-group" style="--anim-delay: 2">
                <h4>
                  {{
                    role === 'therapist'
                      ? ('CONSULTATION.THERAPIST.Specialization' | translate)
                      : ('CONSULTATION.CLIENT.IssueDetail' | translate)
                  }}
                </h4>
                <p class="section-desc">
                  {{
                    'CONSULTATION.CreateProfile.SpecializationDesc' | translate
                  }}
                </p>
            ...
            <div class="step-pane" [class.active-pane]="currentStep === 3">
              <div class="section-group" style="--anim-delay: 1">
                <h4>
                  {{
                    role === 'therapist'
                      ? ('CONSULTATION.THERAPIST.BasicDetails' | translate)
                      : ('CONSULTATION.CreateProfile.LocationDetails'
                        | translate)
                  }}
                </h4>
                <p class="section-desc">
                  {{
                    role === 'therapist'
                      ? ('CONSULTATION.THERAPIST.BasicDetailsDesc' | translate)
                      : ('CONSULTATION.CreateProfile.LocationDesc' | translate)
                  }}
                </p>
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                  <input
                    *ngIf="role === 'therapist'"
                    ...
                    class="form-input"
                    [placeholder]="'CONSULTATION.THERAPIST.Name' | translate"
                  />
                  <input
                    type="text"
                    ...
                    class="form-input"
                    [placeholder]="
                      'CONSULTATION.CreateProfile.CityCountry' | translate
                    "
                  />
                </div>
              </div>
              ...
              >
                <h4>
                  {{
                    'CONSULTATION.THERAPIST.ProfessionalTitleAndExperience'
                      | translate
                  }}
                </h4>
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                  <select
                    formControlName="professional_title_code"
                    class="form-input"
                    style="flex: 2;"
                  >
                    <option value="">
                      {{ 'CONSULTATION.THERAPIST.SelectTitle' | translate }}
                    </option>
                    <option
                  ...
                  <input
                    ...
                    class="form-input"
                    [placeholder]="
                      'CONSULTATION.THERAPIST.ExperienceYears' | translate
                    "
                    style="flex: 1;"
                  />
                </div>
                <input
                  type="text"
                  formControlName="professional_title_display"
                  class="form-input"
                  [placeholder]="
                    'CONSULTATION.THERAPIST.CustomTitle' | translate
                  "
                />
              </div>
              ...
              >
                <p
                  [innerHTML]="
                    'CONSULTATION.CreateProfile.AlmostDoneClient' | translate
                  "
                ></p>
              </div>
            </div>
            ...
            <div
              class="step-pane"
              [class.active-pane]="currentStep === 4"
              *ngIf="role === 'therapist'"
            >
              <div class="section-group" style="--anim-delay: 1">
                <h4>{{ 'CONSULTATION.THERAPIST.Degrees' | translate }}</h4>
                <p class="section-desc">
                  {{ 'CONSULTATION.THERAPIST.DegreesDesc' | translate }}
                </p>
                <div formArrayName="degrees" class="array-list">
                  <div
                    *ngFor="let deg of degrees.controls; let i = index"
                    [formGroupName]="i"
                    class="array-item"
                  >
                    <button
                    ...
                    <select formControlName="type" class="form-input">
                      <option value="">
                        {{ 'CONSULTATION.THERAPIST.DegreeType' | translate }}
                      </option>
                      <option
                        *ngFor="let type of availableDegreeTypes"
                        [value]="type"
                      >
                        {{ type }}
                      </option>
                    ...
                    <input
                      ...
                      class="form-input"
                      [placeholder]="
                        'CONSULTATION.THERAPIST.FieldOfStudy' | translate
                      "
                    />
                    ...
                    <div style="position: relative; flex: 1; min-width: 200px;">
                      <input
                        ...
                        class="form-input"
                        [placeholder]="
                          'CONSULTATION.THERAPIST.Institution' | translate
                        "
                        (input)="onInstitutionSearch($event, i)"
                        (focus)="activeDegreeIndex = i"
                      ...
                      >
                        <div
                          ...
                          *ngFor="let uni of universityResults"
                          (mousedown)="selectUniversity(uni.name, i)"
                        >
                          {{ uni.name }}
                          <small *ngIf="uni.country">({{ uni.country }})</small>
                        </div>
                      </div>
                    </div>
                    ...
                    <input
                      ...
                      class="form-input"
                      [placeholder]="'CONSULTATION.THERAPIST.Year' | translate"
                      style="max-width: 100px;"
                    />
                  </div>
                </div>
                <button type="button" class="btn-add" (click)="addDegree()">
                  {{ 'CONSULTATION.THERAPIST.AddDegree' | translate }}
                </button>
              </div>

              <div class="section-group" style="--anim-delay: 2">
                <h4>
                  {{ 'CONSULTATION.THERAPIST.Certifications' | translate }}
                </h4>
                <p class="section-desc">
                  {{ 'CONSULTATION.THERAPIST.CertificationsDesc' | translate }}
                </p>
                <div formArrayName="certifications" class="array-list">
                  ...
                  >
                    ...
                    <input
                      ...
                      class="form-input"
                      [placeholder]="
                        'CONSULTATION.THERAPIST.CertificationName' | translate
                      "
                    />
                    <input
                      type="text"
                      ...
                      class="form-input"
                      [placeholder]="
                        'CONSULTATION.THERAPIST.Issuer' | translate
                      "
                    />
                    <input
                      type="number"
                ...
                >
                  {{ 'CONSULTATION.THERAPIST.AddCertification' | translate }}
                </button>
              </div>
              ...
              <div class="summary-box" style="--anim-delay: 3">
                <p
                  [innerHTML]="
                    'CONSULTATION.CreateProfile.AlmostDoneTherapist' | translate
                  "
                ></p>
              </div>
            </div>
  ...
  styles: [
    `
      ...
      .step-highlight {
        ...
        height: 60px;
        background: rgba(
          var(--color-primary-rgb, 102, 126, 234),
          0.08
        ); /* Fallback */
        border-radius: 8px;
        z-index: 1;
      ...
      .btn-next {
        ...
        &:hover:not(:disabled) {
          ...
          box-shadow: 0 4px 12px
            rgba(var(--color-primary-rgb, 102, 126, 234), 0.3);
        }
        &:active:not(:disabled) {
      ...
      .form-input {
        ...
        &:focus {
          ...
          box-shadow: 0 0 0 3px
            rgba(var(--color-primary-rgb, 102, 126, 234), 0.15);
        }
      }
...
export class CreateConsultationProfileComponent implements OnInit {
  ...
  availableModes = [
    ...
    { id: 'chat', label: 'CONSULTATION.Modes.Chat', icon: '💬' },
    { id: 'phone', label: 'CONSULTATION.Modes.Phone', icon: '📞' },
  ];
      ...
      .pipe(
        ...
        switchMap((request) => {
          ...
          return this.http
            .get<
              any[]
            >(`http://universities.hipolabs.com/search?name=${encodeURIComponent(request.term)}`)
            .pipe(catchError(() => of([])));
        }),
      )
      .subscribe((results) => {
  ...
  loadExistingProfile() {
    this.consultationProfileService.getCurrentProfile().subscribe({
        ...
        if (res && res.data) {
          ...
          if (this.role === 'therapist') {
            ...
            if (profile.professional_info) {
              if (profile.professional_info.title) {
                this.profileForm.patchValue({
                  professional_title_code:
                    profile.professional_info.title.code || '',
                  professional_title_display:
                    profile.professional_info.title.display || '',
                });
              }
              if (
                profile.professional_info.degrees &&
                Array.isArray(profile.professional_info.degrees)
              ) {
              ...
              if (
                profile.professional_info.certifications &&
                Array.isArray(profile.professional_info.certifications)
              ) {
                profile.professional_info.certifications.forEach(
                  (cert: any) => {
                    this.certifications.push(
                      this.fb.group({
                        name: [cert.name || ''],
      ...
      error: (err) => {
        console.warn(
          'Could not load existing profile, assuming creation flow.',
          err,
        );
      },
    });
  ...
  getStepTitle(): string {
    switch (this.currentStep) {
      case 1:
        return 'CONSULTATION.CreateProfile.StepConfig';
      case 2:
        return 'CONSULTATION.CreateProfile.StepAttributes';
      case 3:
        return 'CONSULTATION.CreateProfile.StepDetails';
      case 4:
        return 'CONSULTATION.THERAPIST.ProfessionalInfo';
      default:
        return '';
    }
  }
  ...
  toggleMode(id: string) {
    this.toggleArrayValue('consultation_modes', id);
  }
  isModeSelected(id: string) {
    return this.isArraySelected('consultation_modes', id);
  }

  toggleLanguage(id: string) {
    this.toggleArrayValue('languages', id);
  }
  isLanguageSelected(id: string) {
    return this.isArraySelected('languages', id);
  }
