      ...
      floatingActionButton: ElevatedButton(
        ...
        child: const Padding(
          padding: EdgeInsets.symmetric(
              horizontal: kDefault / 6, vertical: kDefault / 1.2),
  ...
  Container buildNavbar() {
    return Container(
      ...
      padding: const EdgeInsets.only(
          right: kDefault, bottom: kDefault, left: kDefault, top: kDefault / 2),
            ...
            child: Column(
              children: [
                ...
                Text(
                  "Home",
                  style:
                      TextStyle(color: index == 0 ? Colors.blueAccent : null),
                )
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                Icon(
                  ...
                  size: kCircle / 1.6,
                  color: index == 1 ? Colors.blueAccent : null,
                ),
                Text(
                  "Profile",
                  style:
                      TextStyle(color: index == 1 ? Colors.blueAccent : null),
                )
              ],
            ),
          )
